    ...
    <div class="wrapper">
        ...
        <aside class="main-sidebar sidebar-dark-primary elevation-4">
            ...
            <a href="#" class="brand-link">
                ...
                <span class="brand-text font-weight-light">Anjungan Pasien</span>
            </a>
            ...
            <div class="sidebar">
               ...
               with font-awesome or any other icon font library -->
                        ...
                        <li class="nav-item">
                            <a href="{{ route('dashboard.admindashboard') }}" class="nav-link active">
                        ...
                        <li class="nav-item">
                            <a href="{{ route('createuser.index') }}" class="nav-link ">
                        ...
                        <li class="nav-item">
                            <a href="{{ route('rs.create') }}" class="nav-link ">
                                <i class="nav-icon fas fa-desktop"></i>
                                <p>
                                    Logo Rumah Sakit
                                </p>
