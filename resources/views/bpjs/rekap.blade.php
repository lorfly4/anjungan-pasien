...
<body class="bg-gray-200 min-h-screen flex flex-col items-center justify-start py-10 px-4">
    <header class="w-full max-w-5xl flex items-center justify-center relative mb-10">
        <a class="absolute left-4 top-1/2 -translate-y-1/2 bg-blue-600 text-white px-4 py-2 rounded flex items-center gap-2 hover:bg-blue-700 transition" href="{{ url()->previous() }}">
            <i class="fas fa-arrow-left"></i>
            back
        </a>
        <div class="text-center">
            <div class="flex items-center justify-center gap-1 mb-1">
                <img alt="Metro Cikupa logo with blue and yellow squares" class="w-6 h-6" height="24" src="https://storage.googleapis.com/a1aa/image/47ccaaf0-e3cd-4cfe-53ba-abe9b70be5b9.jpg" width="24"/>
